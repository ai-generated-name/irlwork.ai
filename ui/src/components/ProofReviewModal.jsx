...
function ProofReviewModal({ task, onClose, onApprove, onReject }) {
  ...
  return (
    <div className="modal-overlay" style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000, padding: 24 }}>
      <div style={{ background: 'white', borderRadius: 16, maxWidth: 520, width: '100%', padding: 24, boxShadow: '0 20px 60px rgba(0,0,0,0.06)', maxHeight: '90vh', overflowY: 'auto' }}>
        ...
        <div style={{ display: 'flex', gap: 12, marginTop: 24 }}>
          ...
          <Button variant="primary" size="md" className="flex-1 !bg-[#2D7A3A] hover:!bg-[#15803D]" onClick={onApprove}>
            Approve & pay
          </Button>
        </div>
        {rejecting && (
