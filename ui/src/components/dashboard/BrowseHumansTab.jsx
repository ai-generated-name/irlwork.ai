              ...
              <>
                ...
                <div className="browse-humans-filters" style={{ flexWrap: 'wrap' }}>
                  ...
                  <button
                    ...
                    style={{ display: 'none', alignItems: 'center', gap: 6, padding: '10px 16px', background: 'var(--bg-tertiary)', border: '1px solid rgba(220,200,180,0.35)', borderRadius: 11, fontSize: 13, fontWeight: 500, color: 'var(--text-secondary)', cursor: 'pointer', whiteSpace: 'nowrap' }}
                  >
                  ...
                  if (humansError) {
                    return (
                      <div className="dashboard-v4-empty" style={{ padding: '32px 16px', textAlign: 'center' }}>
                        ...
                        <button
                          onClick={fetchHumans}
                          style={{ background: 'var(--coral-500, #E8703D)', color: 'white', border: 'none', borderRadius: 11, padding: '10px 20px', fontSize: 14, fontWeight: 600, cursor: 'pointer' }}
                        >
                          Try Again
                        </button>
                  ...
                  return filtered.length === 0 ? (
                    <div className="dashboard-v4-empty" style={{ padding: '32px 16px', textAlign: 'center' }}>
                      ...
                      <button
                        ...
                        style={{ background: 'transparent', color: 'var(--text-secondary)', border: '1px solid rgba(220,200,180,0.40)', borderRadius: 11, padding: '10px 20px', fontSize: 14, fontWeight: 600, cursor: 'pointer', display: 'inline-flex', alignItems: 'center', gap: 8 }}
                      >
