...
const PLANS = [
  {
    ...
    features: [
      ...
      { text: 'Direct hiring', included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Direct hiring', included: true },
      { text: 'Priority listing (+1)', included: true },
  ...
  },
  {
    ...
    posterFee: 0,
    popular: true,
    description: 'Lowest fees, top priority, gold badge',
    features: [
      { text: 'Unlimited task posting', included: true },
      { text: '10% worker fee', included: true },
      { text: 'Direct hiring', included: true },
      { text: 'Top listing priority (+2)', included: true },
