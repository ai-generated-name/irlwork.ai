  ...
  return (
    <div className="bg-white rounded-2xl border-2 border-[rgba(26,26,26,0.08)] p-4 sm:p-6 shadow-sm">
      ...
      <div className="text-center mb-3 sm:mb-4">
        ...
        <div className="text-xs sm:text-sm text-[#8A8A8A] mt-1">
      ...
      {canApply && (
        <button
          onClick={onApply}
          className="w-full mt-3 sm:mt-4 py-2.5 sm:py-3 bg-[#E07A5F] hover:bg-[#C45F4A] text-white font-bold rounded-xl transition-colors text-sm sm:text-base shadow-md"
        >
          Apply for This Task
        </button>
      )}
      ...
      {showSignIn && (
        <a
          href="/auth"
          className="block w-full mt-3 sm:mt-4 py-2.5 sm:py-3 bg-[#E07A5F] hover:bg-[#C45F4A] text-white font-bold rounded-xl transition-colors text-sm sm:text-base shadow-md text-center no-underline"
        >
          Sign In to Apply
        </a>
      )}
