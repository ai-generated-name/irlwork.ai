    ...
    if (savedAddress) {
      return (
        <div className="flex items-center gap-2 px-3 py-2 bg-[#f0fdf4] border border-[#86efac] rounded-lg">
          ...
          <span className="text-xs font-semibold text-[#2D7A3A] truncate">
        ...
        <div className="space-y-2">
          ...
          <div className="flex gap-2">
            ...
            <button
              onClick={handleSave}
              disabled={saving}
              className="flex-1 py-2 bg-[#6366f1] hover:bg-[#4f46e5] disabled:bg-[#A69E98] text-white rounded-lg text-xs font-semibold transition-colors"
            >
          ...
          <div className="mt-4 space-y-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="px-6 py-2.5 bg-[#6366f1] hover:bg-[#4f46e5] disabled:bg-[#A69E98] text-white rounded-xl text-sm font-bold transition-all"
              >
