...
export default function EmptyState({
  ...
  return (
    <div className="bg-white rounded-2xl border border-[#E8E0D8] p-8 md:p-12 shadow-v4-sm text-center">
      ...
      <p className="text-sm md:text-base text-[#8C8580] mb-6 md:mb-8 max-w-md mx-auto">{description}</p>
