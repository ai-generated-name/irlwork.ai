...
function MCPGenericIcon({ size = 20 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect x="3" y="6" width="18" height="12" rx="3" stroke="#B3AFAC" strokeWidth="1.5"/>
      <circle cx="8" cy="12" r="1.5" fill="#B3AFAC"/>
      <circle cx="12" cy="12" r="1.5" fill="#B3AFAC"/>
      <circle cx="16" cy="12" r="1.5" fill="#B3AFAC"/>
    </svg>
  )
}
