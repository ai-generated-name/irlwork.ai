                    ...
                    >
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 12 }}>
                        ...
                        <div style={{ display: 'flex', gap: 6 }}>
                          {task.task_type === 'open' && (
                            <span style={{ padding: '4px 10px', borderRadius: 'var(--radius-full)', fontSize: 12, fontWeight: 500, background: 'rgba(109,79,194,0.09)', color: '#6D4FC2' }}>Open</span>
                          )}
                          {task.quantity > 1 && (
                            <span style={{ padding: '4px 10px', borderRadius: 'var(--radius-full)', fontSize: 12, fontWeight: 500, background: 'rgba(37,99,235,0.09)', color: '#2563EB' }}>
