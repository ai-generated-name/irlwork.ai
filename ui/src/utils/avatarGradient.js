const GRADIENTS = {
  ...
  C: 'linear-gradient(135deg, #86EFAC, #16A34A)',
  ...
  I: 'linear-gradient(135deg, #C4B5FD, #7C3AED)',
  J: 'linear-gradient(135deg, #B8A5F5, #6B4FBF)',
  K: 'linear-gradient(135deg, #6EE7B7, #059669)',
  ...
  Q: 'linear-gradient(135deg, #6EE7B7, #10B981)',
  R: 'linear-gradient(135deg, #F5A07A, #EA580C)',
  S: 'linear-gradient(135deg, #7EC8F8, #3B82F6)',
